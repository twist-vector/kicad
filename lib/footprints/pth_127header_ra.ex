defmodule Footprints.PTH127HeaderRA do
  alias Footprints.Components, as: Comps

  @library_name "PTH_Headers"
  @device_file_name "PTH127Header_devices.yml"
  ...
  def create_mod(params, pincount, rowcount, filename) do
    ...
    m = Comps.module(name: "Header_#{pincount}x#{rowcount}_RA",
                     ...
                     descr: "#{pincount}x#{rowcount} 0.05in (1.27 mm) spacing right angle unshrouded header",
